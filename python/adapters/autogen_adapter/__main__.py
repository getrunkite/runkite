...
def main():
    parser = argparse.ArgumentParser(description="Runkite AutoGen runner")
    ...
    parser.add_argument("--runner-kind", default="python-autogen", help="Runner kind identifier")
    parser.add_argument(
        "--concurrency",
        type=int,
    ...
    asyncio.run(run_worker(AutoGenAdapter(), args.config, args.grpc_address, args.runner_kind, args.concurrency))
