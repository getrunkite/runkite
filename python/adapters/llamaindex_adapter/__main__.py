...
def main():
    parser = argparse.ArgumentParser(description="Runkite LlamaIndex runner")
    ...
    parser.add_argument("--runner-kind", default="python-llamaindex", help="Runner kind identifier")
    parser.add_argument(
        "--concurrency",
        type=int,
    ...
    asyncio.run(run_worker(LlamaIndexAdapter(), args.config, args.grpc_address, args.runner_kind, args.concurrency))
