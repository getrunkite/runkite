...
| [Runner Protocol](runner-protocol/README.md) · [`PROTOCOL.md`](runner-protocol/PROTOCOL.md) · [public mirror](https://github.com/getrunkite/runner-protocol) | Worker contract (gRPC + opaque checkpoints) |
