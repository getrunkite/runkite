...
`docker-compose.test.yml` starts ephemeral, tmpfs-backed Postgres + MySQL + Redis + MongoDB + Qdrant + Weaviate + [Pinecone Local](https://docs.pinecone.io/guides/operations/local-development) for running the conformance test suite (see Development below), on non-standard ports (5433/3307/6380/27018/6333/8080/5080-5200) specifically to avoid colliding with the full-stack compose above or any local services:
